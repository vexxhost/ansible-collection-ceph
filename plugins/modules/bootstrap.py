...
#
# Vendored from:
#   https://github.com/ceph/cephadm-ansible/blob/fbe6eccd705ed203e5ce30a2cf33d9e77e98d4c9/plugins/modules/cephadm_bootstrap.py
...
#   - dashboard_password_noupdate: added no_log=False (it is a bool, not a
#     secret) to silence a spurious Ansible no_log warning.
...
from ansible_collections.vexxhost.ceph.plugins.module_utils.common import exit_module
import datetime
import os
...
def main() -> None:
    ...
    cephadm_bootstrap_params = dict(
        ...
        dashboard_password_noupdate=dict(type='bool', required=False, no_log=False),
