...
# ---------------------------------------------------------------------------
# Vendored from:
#   https://github.com/ceph/ceph-ansible/blob/8599b192d33e1c55104c1c2fd1abfa8431c64664/library/ceph_crush_rule.py
...
from ansible_collections.vexxhost.ceph.plugins.module_utils.common import exit_module, generate_cmd, is_containerized, exec_command
import datetime
import json
