...
def generate_ceph_cmd(cmd='ceph',
                 sub_cmd=None,
                 args=None,
                 user_key=None,
                 cluster='ceph',
    ...
    cmd = pre_generate_ceph_cmd(cmd, container_image=container_image, interactive=interactive)  # noqa: E501
...
def pre_generate_ceph_cmd(cmd, container_image=None, interactive=False):
    '''
